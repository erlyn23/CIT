    ...
    public partial class UsersLenderBusinessMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconClass = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Route = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_lenderbusinesses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Operation = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ResultMessageOrObject = table.Column<string>(type: "varchar(1500)", maxLength: 1500, nullable: true, defaultValueSql: "'NULL'")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_userslenderbusinesses", x => x.Id);
                    table.ForeignKey(
                        name: "Fk_UsersLenderBusinesses_LenderBusinesses",
                        column: x => x.LenderBusinessId,
                        principalTable: "lenderbusinesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "Fk_UsersLenderBusinesses_Users",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => new { x.Id, x.RoleId, x.LenderBusinessId });
                    table.ForeignKey(
                        name: "Fk_LenderRole_LenderBusiness",
                        column: x => x.LenderBusinessId,
                        principalTable: "lenderbusinesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "Fk_LenderRole_Roles",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "Fk_UsersLenderBusinesses_LenderBusiness",
                table: "userslenderbusinesses",
                column: "LenderBusinessId");
